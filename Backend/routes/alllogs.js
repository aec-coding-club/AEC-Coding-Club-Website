...
const { getlogs, branchdata, yeardata, alluser, eventsdata, userupdate } = require('../controllers/alllogs')
...
router.post('/updateuser/:id', isAuthenticated, isActivated, isAdmin, userupdate)
